                ...
                <View style={styles.screen}>
                    <View style={styles.container}>
                        {chartEnable ? <></>:
                            <View style={styles.IOchoiceContainer}>
                                <View style={styles.IOContainer}>
                                    <Text style={styles.IOchoiceLabel}>I/O Chart: </Text>
                                    <Switch 
                                ...
                                <View style={styles.IOContainer}>
                                    <Text style={styles.IOchoiceLabel}>I/O Method: </Text>
                                    <Picker
                        ...
                        <View style={{ ...styles.rows, borderBottomWidth: 2, marginBottom: 5 }}>
                            ...
                            <View style={styles.itemContainer}>
                                <Text style={styles.caption}>
                                    {IOdevice || selectedAlgorithm.shortName === "PSP"  || selectedAlgorithm.shortName === "PSNP" ? "Cpu" : "Burst Time" }
                                </Text>
                            </View>
